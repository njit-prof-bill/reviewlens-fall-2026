...
| ID  | Criterion                                                                     | Evidence to Observe                                                                                             | Sprint 1 Story Coverage        | Score |
| --- | ----------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | ------------------------------ | ----- |
| C10 | Ingestion can be initiated for an owned AnalysisTarget                        | User A starts ingestion from the source URL of a target they own                                                | S1-019                         |       |
| C11 | Application obtains real review data through the URL-driven ingestion path    | Team shows source-derived review data rather than hard-coded fabricated demo records                            | S1-020                         |       |
